...
local blank_testing_grid_interface =
{
  get_created_items = function()
    return global.created_items
  end,
  set_created_items = function(map)
    global.created_items = map or error("Remote call parameter to blank_testing_grid set created items can't be nil.")
  end,
  get_respawn_items = function()
    return global.respawn_items
  end,
  set_respawn_items = function(map)
    global.respawn_items = map or error("Remote call parameter to blank_testing_grid set respawn items can't be nil.")
  end,
  ...
  set_chart_distance = function(value)
    global.chart_distance = tonumber(value) or error("Remote call parameter to blank_testing_grid set chart distance must be a number")
  end,
  ...
  set_ship_items = function(map)
    global.crashed_ship_items = map or error("Remote call parameter to blank_testing_grid set created items can't be nil.")
  end,
  get_debris_items = function()
    return global.crashed_debris_items
  end,
  set_debris_items = function(map)
    global.crashed_debris_items = map or error("Remote call parameter to blank_testing_grid set respawn items can't be nil.")
  end,
  get_ship_parts = function()
    return global.crashed_ship_parts
  end,
  set_ship_parts = function(parts)
    global.crashed_ship_parts = parts or error("Remote call parameter to blank_testing_grid set ship parts can't be nil.")
  end
}

if not remote.interfaces["blank_grid"] then
  remote.add_interface("blank_grid", blank_testing_grid_interface)
end
...
local blank_testing_grid = {}

blank_testing_grid.events =
{
...
blank_testing_grid.on_configuration_changed = function()
...
blank_testing_grid.on_init = function()
